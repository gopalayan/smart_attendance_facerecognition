...
class Student:
   def __init__(self,root):
     ...
     # ***student3**********
     img1=Image.open(r"C:\Users\gopal\Desktop\project image\student3.jpg")
     ...
     #************student2*************
     img2=Image.open(r"C:\Users\gopal\Desktop\project image\student2page.jpg")
     ...
     #***********student4**********
     img3=Image.open(r"C:\Users\gopal\Desktop\project image\student4.jpg")
...
#left image
     ...
     img_left=Image.open(r"C:\Users\gopal\Desktop\project image\frameimage1.jpg")
...
#course and combo box
     ...
     save_button=Button(button_frame,text="Save",command=self.add_data,width=15,font=("times new roman",15,"bold"),bg="blue",fg="green",activebackground="red")
     ...
     #*****back button**********
     back_button=Button(button_frame,text=">>BACK",width=12,command=self.dash,font=("times new roman",11,"bold"),bg="blue",fg="green")
     ...
     right_frame.place(x=780,y=0,width=660,height=580)
      #right img
     img_right=Image.open(r"C:\Users\gopal\Desktop\project image\student and teacher pic right frame.jpg")
...
#("dep","course","year","sem","id","dob","name","email","div","roll","gender","phone","address","teacher","photo")
  ...
  #function declaration
   def add_data(self):
          if self.var_dep.get()=="select Department" or self.var_std_name.get()==" " or self.var_student_id.get()==" ":
              ...
              try:
                    ...
                    my_cursor.execute("insert into student3 values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
   ...
   def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="W2002@gopal#",database="face_recognition1")
        my_cursor=conn.cursor()
        my_cursor.execute("select * from student3")
        ...
        if self.var_dep.get() == "select Department" or self.var_std_name.get() == " " or self.var_student_id.get() == " ":
            ...
            try:
                ...
                update_query = """
                    ...
                    division=%s,roll=%s,gender=%s,phone=%s,address=%s,teacher=%s,
                    photosample=%s 
                    WHERE studentid=%s
                """
   ...
   def dash(self):
    from main import Face_Recognitation_system
    self.new_window=self.root
    self.app2=Face_Recognitation_system(self.new_window)
