...
from attendence import Attendance_page
...
class Face_Recognitation_system:
  def __init__(self,root):
     ...
     img1=Image.open(r"C:\Users\gopal\Desktop\minor project\face image.jpg")
     ...
     img2=Image.open(r"C:\Users\gopal\Desktop\minor project\checkimage.jpg")
     ...
     img3=Image.open(r"C:\Users\gopal\Desktop\project image\image3.jpg")
     ...
     label3.place(x=1000,y=0,width=500,height=130)
      ...
      #bg image
     img4=Image.open(r"C:\Users\gopal\Desktop\project image\bgimage.jpg")
     ...
     title_lbl.place(x=0,y=0,width=1530,height=30)
      ...
      #student button
     img5=Image.open(r"C:\Users\gopal\Desktop\project image\studentbutton.jpg")
     img5=img5.resize((220,220))
     self.PhotoImage5=ImageTk.PhotoImage(img5) 

     b1=Button(bg_image,command=self.My_work,image=self.PhotoImage5,cursor="hand2")
     b1.place(x=150,y=55,width=220,height=220)
     
     b1_1=Button(bg_image,command=self.My_work,text="Student Details",cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
     b1_1.place(x=150,y=275,width=220,height=40)

     #face recognition
     img6=Image.open(r"C:\Users\gopal\Desktop\project image\facebutton.jpg")
     img6=img6.resize((220,220))
     self.PhotoImage6=ImageTk.PhotoImage(img6) 
     b2=Button(bg_image,image=self.PhotoImage6,command=self.face_data,cursor="hand2")
     b2.place(x=450,y=55,width=220,height=220)
     
     b2_2=Button(bg_image,text="Face Recognition" ,cursor="hand2",command=self.face_data,font=("times new roman",15,"bold"),bg="blue",fg="white")
     b2_2.place(x=450,y=275,width=220,height=40)
     
     #attendence
     img7=Image.open(r"C:\Users\gopal\Desktop\project image\attendencebutton.jpg")
     ...
     b3_3=Button(bg_image,text="Attendence" ,command=self.attendence_data,cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
     b3_3.place(x=750,y=275,width=220,height=40)
     

     #help
     img8=Image.open(r"C:\Users\gopal\Desktop\project image\helpbutton.jpg")
     ...
     b4_4=Button(bg_image,text="Help Desk" ,command=self.helpdesk,cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
     b4_4.place(x=1050,y=275,width=220,height=40)
     
     #train 
     img9=Image.open(r"C:\Users\gopal\Desktop\project image\trainbutton.jpg")
     img9=img9.resize((220,220))
     self.PhotoImage9=ImageTk.PhotoImage(img9) 
     b5=Button(bg_image,image=self.PhotoImage9,command=self.train_data,cursor="hand2")
     b5.place(x=150,y=335,width=220,height=220)
     
     b5_5=Button(bg_image,text="Train Data" ,cursor="hand2",command=self.train_data,font=("times new roman",15,"bold"),bg="blue",fg="white")
     b5_5.place(x=150,y=525,width=220,height=40)

     #photo
     img10=Image.open(r"C:\Users\gopal\Desktop\project image\photobutton.jpg")
     img10=img10.resize((220,220))
     self.PhotoImage10=ImageTk.PhotoImage(img10) 
     b6=Button(bg_image,image=self.PhotoImage10,cursor="hand2")
     b6.place(x=450,y=335,width=220,height=220)
     
     b6_6=Button(bg_image,text="Photos" ,cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
     b6_6.place(x=450,y=525,width=220,height=40)

     #developer
    
     img11=Image.open(r"C:\Users\gopal\Desktop\project image\developarbutton.jpg")
     ...
     img12=Image.open(r"C:\Users\gopal\Desktop\project image\exitbutton.jpg")
  ...
  def helpdesk(self):
       self.new_window=Toplevel(self.root)
       self.app1=ChatBot(self.new_window)

  def attendence_data(self):
       self.new_window=Toplevel(self.root)
       self.app1=Attendance_page(self.new_window)
